...
*/
$app->post(url_base() . 'Gasten/CreateTable', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Gasten/CreateTable: " .$exception);
...
*/
$app->post(url_base() . 'Gasten/CreateViews', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Gasten/CreateViews: " .$exception);
...
*/
$app->get(url_base() . 'Gasten/GetObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/Gasten/GetObject: " .$exception);
...
*/
$app->get(url_base() . 'Gasten/GetObjects', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Gasten/GetObjects: " .$exception);
...
*/
$app->delete(url_base() . 'Gasten/DeleteObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/Gasten/DeleteObject: " .$exception);
...
*/
$app->patch(url_base() . 'Gasten/RestoreObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/Gasten/RestoreObject: " .$exception);
...
*/
$app->post(url_base() . 'Gasten/SaveObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Gasten/SaveObject: " .$exception);
...
*/
$app->put(url_base() . 'Gasten/SaveObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Gasten");
    try
    {
        $data = json_decode($request->getBody(), true);
