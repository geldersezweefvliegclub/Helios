...
*/
$app->post(url_base() . 'Documenten/CreateTable', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Documenten/CreateTable: " .$exception);
...
*/
$app->post(url_base() . 'Documenten/CreateViews', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Documenten/CreateViews: " .$exception);
...
*/
$app->get(url_base() . 'Documenten/GetObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/Documenten/GetObject: " .$exception);
...
*/
$app->get(url_base() . 'Documenten/GetObjects', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Documenten/GetObjects: " .$exception);
...
*/
$app->delete(url_base() . 'Documenten/DeleteObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/Documenten/DeleteObject: " .$exception);
...
*/
$app->patch(url_base() . 'Documenten/RestoreObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/Documenten/RestoreObject: " .$exception);
...
*/
$app->post(url_base() . 'Documenten/SaveObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/Documenten/SaveObject: " .$exception);
...
*/
$app->put(url_base() . 'Documenten/SaveObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("Documenten");
    try
    {
        $data = json_decode($request->getBody(), true);
