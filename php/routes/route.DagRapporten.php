...
*/
$app->post(url_base() . 'DagRapporten/CreateTable', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/DagRapporten/CreateTable: " .$exception);
...
*/
$app->post(url_base() . 'DagRapporten/CreateViews', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/DagRapporten/CreateViews: " .$exception);
...
*/
$app->get(url_base() . 'DagRapporten/GetObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
        $params = $request->getQueryParams();
        ...
        $d = $obj->GetObject($id);  // Hier staat de logica voor deze functie
        if ($d === null)
        {
    ...
    {
        Debug(__FILE__, __LINE__, "/DagRapporten/GetObject: " .$exception);
...
*/
$app->get(url_base() . 'DagRapporten/GetObjects', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/DagRapporten/GetObjects: " .$exception);
...
*/
$app->delete(url_base() . 'DagRapporten/DeleteObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/DagRapporten/DeleteObject: " .$exception);
...
*/
$app->patch(url_base() . 'DagRapporten/RestoreObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
        $params = $request->getQueryParams();
    ...
    {
        Debug(__FILE__, __LINE__, "/DagRapporten/RestoreObject: " .$exception);
...
*/
$app->post(url_base() . 'DagRapporten/SaveObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
    ...
    {
        Debug(__FILE__, __LINE__, "/DagRapporten/SaveObject: " .$exception);
...
*/
$app->put(url_base() . 'DagRapporten/SaveObject', function (Request $request, Response $response, $args) {
    $obj = MaakObject("DagRapporten");
    try
    {
        $data = json_decode($request->getBody(), true);
